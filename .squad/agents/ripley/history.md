...
- **Project:** Microsoft Communications Portal — single-pane-of-glass web app aggregating Microsoft update/health streams (Power Platform release plans, M365 Roadmap RSS, Azure Updates RSS, M365 Message Center via Graph, M365 Service Health via Graph). Optional Azure Service/Resource Health via Azure Management API.
